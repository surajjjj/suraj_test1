...
class S {
  ...
  /// `Best restaurants`
  String get best_restaurants {
    return Intl.message(
      'Best restaurants',
      name: 'best_restaurants',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Recommended shop`
  String get recommended_shop {
    return Intl.message(
      'Recommended shop',
      name: 'recommended_shop',
      desc: '',
      args: [],
    );
  }

  /// `Food is being placed`
  String get food_is_being_placed {
    return Intl.message(
      'Food is being placed',
      name: 'food_is_being_placed',
      desc: '',
      args: [],
    );
  }
  ...
  String get write_instructions_for_restaurant {
    return Intl.message(
      'Write instructions for restaurant',
      name: 'write_instructions_for_restaurant',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Offers benefits`
  String get offers_benefits {
    return Intl.message(
      'Offers benefits',
      name: 'offers_benefits',
      desc: '',
      args: [],
    );
  }

  /// `Thank your partner with tip`
  String get thank_your_partner_with_tip {
    return Intl.message(
      'Thank your partner with tip',
      name: 'thank_your_partner_with_tip',
      desc: '',
      args: [],
    );
  }

  /// `The amount will be credited to the partners tip jar`
  String get the_amount_will_be_credited_to_the_partners_tip_jar {
    return Intl.message(
      'The amount will be credited to the partners tip jar',
      name: 'the_amount_will_be_credited_to_the_partners_tip_jar',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Leave with guard`
  String get leave_with_guard {
    return Intl.message(
      'Leave with guard',
      name: 'leave_with_guard',
      desc: '',
      args: [],
    );
  }
  ...
  String get your_delivery_partner_is_travelling_long_distance_to_deliver_your_order {
    return Intl.message(
      'Your delivery partner is travelling long distance to deliver your order',
      name: 'your_delivery_partner_is_travelling_long_distance_to_deliver_your_order',
      desc: '',
      args: [],
    );
  }
  ...
  String get review_your_order_and_address_details_to_avoid_cancellations {
    return Intl.message(
      'Review your order and address details to avoid cancellations',
      name: 'review_your_order_and_address_details_to_avoid_cancellations',
      desc: '',
      args: [],
    );
  }
  ...
  /// `If you cancel within 60 seconds of placing your order a 100% refund will be issued. No refund for cancellatio madee for 60 seconds`
  String get if_you_cancel_within_60_seconds_of_placing_your_order_a_100_refund_will_be_issued_no_refund_for_cancellatio_made_for_60_seconds {
    return Intl.message(
      'If you cancel within 60 seconds of placing your order a 100% refund will be issued. No refund for cancellatio madee for 60 seconds',
      name: 'if_you_cancel_within_60_seconds_of_placing_your_order_a_100_refund_will_be_issued_no_refund_for_cancellatio_made_for_60_seconds',
      desc: '',
      args: [],
    );
  }
  ...
  String get avoid_cancellation_as_it_leads_to_food_wastage {
    return Intl.message(
      'Avoid cancellation as it leads to food wastage',
      name: 'avoid_cancellation_as_it_leads_to_food_wastage',
      desc: '',
      args: [],
    );
  }
  ...
  String get read_cancellation_policy {
    return Intl.message(
      'Read cancellation policy',
      name: 'read_cancellation_policy',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Delivery at home`
  String get delivery_at_home {
    return Intl.message(
      'Delivery at home',
      name: 'delivery_at_home',
      desc: '',
      args: [],
    );
  }
  ...
  String get more_payment_options {
    return Intl.message(
      'More payment options',
      name: 'more_payment_options',
      desc: '',
      args: [],
    );
  }

  /// `Accept all restaurant`
  String get accept_all_restaurant {
    return Intl.message(
      'Accept all restaurant',
      name: 'accept_all_restaurant',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Change your address`
  String get change_your_address {
    return Intl.message(
      'Change your address',
      name: 'change_your_address',
      desc: '',
      args: [],
    );
  }
  ...
  String get current_location_using_gps {
    return Intl.message(
      'Current location using gps',
      name: 'current_location_using_gps',
      desc: '',
      args: [],
    );
  }
  ...
  String get special_cooking_instructions {
    return Intl.message(
      'Special cooking instructions',
      name: 'special_cooking_instructions',
      desc: '',
      args: [],
    );
  }

  /// `The restart will follow your instructions on the effort basis no refunds or cancellations will be processed based on failure to comply with requests for special instructions`
  String get the_restart_will_follow_your_instructions_on_the_effort_basis_no_refunds_or_cancellations_will_be_processed_based_on_failure_to_comply_with_requests_for_special_instructions {
    return Intl.message(
      'The restart will follow your instructions on the effort basis no refunds or cancellations will be processed based on failure to comply with requests for special instructions',
      name: 'the_restart_will_follow_your_instructions_on_the_effort_basis_no_refunds_or_cancellations_will_be_processed_based_on_failure_to_comply_with_requests_for_special_instructions',
      desc: '',
      args: [],
    );
  }

  /// `Biojmandu has no role to play in taxes and charges being leived upon by the govt.and restaurants`
  // String get biojmandu_has_no_role_to_play_in_taxes_and_charges_being_leived_upon_by_the_govt_and_restaurants {
  //   return Intl.message(
  //     'Biojmandu has no role to play in taxes and charges being leived upon by the govt.and restaurants',
  //     name: 'biojmandu_has_no_role_to_play_in_taxes_and_charges_being_leived_upon_by_the_govt_and_restaurants',
  //     desc: '',
  //     args: [],
  //   );
  // }
  ...
  String get restaurant_packaging_charges {
    return Intl.message(
      'Restaurant packaging charges',
      name: 'restaurant_packaging_charges',
      desc: '',
      args: [],
    );
  }
  ...
  String get set_delivery_loaction {
    return Intl.message(
      'Set delivery loaction',
      name: 'set_delivery_loaction',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Search,area,street`
  String get search_area_street {
    return Intl.message(
      'Search,area,street',
      name: 'search_area_street',
      desc: '',
      args: [],
    );
  }
  ...
  String get thank_your_delivery_partner_for_helping_you_stay_safe_indoors_support_them_through_these_toug_times_wit_a_trip {
    return Intl.message(
      'Thank your delivery partner for helping you stay safe indoors support them through these tough times with a trip',
      name: 'thank_your_delivery_partner_for_helping_you_stay_safe_indoors_support_them_through_these_toug_times_wit_a_trip',
      desc: '',
      args: [],
    );
  }
  ...
  String get your_cart_contains_items_from_all_new_shop_do_you_want_to_clear_the_cart_and_raise_the_new_order {
    return Intl.message(
      'Your cart contains items from all new shop.do you want to clear the cart and raise the new order',
      name: 'your_cart_contains_items_from_all_new_shop_do_you_want_to_clear_the_cart_and_raise_the_new_order',
      desc: '',
      args: [],
    );
  }
  ...
  String get swipe {
    return Intl.message(
      'Swipe up  and Enter Full Adress',
      name: 'swipe',
      desc: '',
      args: [],
    );
  ...
  String get our_delivery_partner_will_after_reaching_and_leave_the_order_at_your_door_gate_not_applicable_for_cod {
    return Intl.message(
      'Our Delivery partner will after reaching and leave the order at your door gate(Not Applicable for COD)',
      name: 'our_delivery_partner_will_after_reaching_and_leave_the_order_at_your_door_gate_not_applicable_for_cod',
      desc: '',
      args: [],
    );
  }
  ...
  String get if_you_choose_to_cancel_you_can_do_it_with_60_seconds_after_placing_the_order {
    return Intl.message(
      'If you Choose to cancel you can do it with timer seconds after placing the order',
      name: 'if_you_choose_to_cancel_you_can_do_it_with_60_seconds_after_placing_the_order',
      desc: '',
      args: [],
    );
  }
  ...
  String get however_in_the_event_of_an_unusual_delay_of_your_order_you_will_not_be_charged_a_cancellation_fees {
    return Intl.message(
      'However in the event of an unusual delay of your order you will not be charged a cancellation fees',
      name: 'however_in_the_event_of_an_unusual_delay_of_your_order_you_will_not_be_charged_a_cancellation_fees',
      desc: '',
      args: [],
    );
  }
  ...
  String get this_policy_helps_us_avoid_food_wastage_and_compensate_restaurant_delivey_partners_for_their_reports {
    return Intl.message(
      'This policy helps us avoid food wastage and compensate restaurant / delivey partners for their reports',
      name: 'this_policy_helps_us_avoid_food_wastage_and_compensate_restaurant_delivey_partners_for_their_reports',
      desc: '',
      args: [],
    );
  }
  ...
  String get the_order_will_be_delivered_to_you_at_your_shared_address_delivery_charges_will_apply {
    return Intl.message(
      'The order Will be delivered to you at your shared address. Delivery charges will apply',
      name: 'the_order_will_be_delivered_to_you_at_your_shared_address_delivery_charges_will_apply',
      desc: '',
      args: [],
    );
  }
  ...
  String get you_will_have_to_pick_up_the_order_yourself_from_the_restaurant_the_order_wont_be_delivered_to_your_location {
    return Intl.message(
      'You will have to pick up the order yourself from the restaurant. The order wont be delivered to your location',
      name: 'you_will_have_to_pick_up_the_order_yourself_from_the_restaurant_the_order_wont_be_delivered_to_your_location',
      desc: '',
      args: [],
    );
  }
  ...
  String get i_have_cancelled_your_order_as_per_request_we_have_not_charged_you_any_cancellation {
    return Intl.message(
      'I have cancelled your order as per request we have not charged you any cancellation',
      name: 'i_have_cancelled_your_order_as_per_request_we_have_not_charged_you_any_cancellation',
      desc: '',
      args: [],
    );
  }
  ...
  String get before_we_end_our_conversation_may_i_please_know_why_you_cancelled_your_order {
    return Intl.message(
      'Before we end our conversation may i please know why you cancelled your order',
      name: 'before_we_end_our_conversation_may_i_please_know_why_you_cancelled_your_order',
      desc: '',
      args: [],
    );
  }
  ...
  String get your_attaches_prescription_will_be_secure_and_private_only_our_pharmacist_will_review_it {
    return Intl.message(
      'Your attaches prescription will be secure and private. Only our pharmacist will review it',
      name: 'your_attaches_prescription_will_be_secure_and_private_only_our_pharmacist_will_review_it',
      desc: '',
      args: [],
    );
  }
  ...
  String get government_regulation_require_a_prescription_for_ordering_some_medicines {
    return Intl.message(
      'Government regulation require a prescription for ordering some medicines',
      name: 'government_regulation_require_a_prescription_for_ordering_some_medicines',
      desc: '',
      args: [],
    );
  }
  ...
  String get details_from_your_prescription_are_not_shared_with_any_third_party {
    return Intl.message(
      'Details from your prescription are not shared with any third party',
      name: 'details_from_your_prescription_are_not_shared_with_any_third_party',
      desc: '',
      args: [],
    );
  }
  ...
  String get never_lose_the_digital_copy_of_your_prescription_it_will_be_with_you_wherever_you_go {
    return Intl.message(
      'Never lose the digital copy of your prescription. It will be with you wherever you go',
      name: 'never_lose_the_digital_copy_of_your_prescription_it_will_be_with_you_wherever_you_go',
      desc: '',
      args: [],
    );
  }
  ...
  String get the_order_will_be_delivered_to_you_at_your_shared_address_at_scheduled_time {
    return Intl.message(
      'The order will be delivered to you at your shared address at scheduled time',
      name: 'the_order_will_be_delivered_to_you_at_your_shared_address_at_scheduled_time',
      desc: '',
      args: [],
    );
  }
  ...
  String get its_your_prescription_hart_to_understand_1mg_pharmacist_will_help_you_in_placing_order {
    return Intl.message(
      'Its your prescription hart to understand? 1mg pharmacist will help you in placing order',
      name: 'its_your_prescription_hart_to_understand_1mg_pharmacist_will_help_you_in_placing_order',
      desc: '',
      args: [],
    );
  }
  ...
  String get we_are_not_delivering_here_at_the_moment_please_try_again_different_location_or_try_again_later {
    return Intl.message(
      'We are not delivering here at the moment please try again different location or try again later',
      name: 'we_are_not_delivering_here_at_the_moment_please_try_again_different_location_or_try_again_later',
      desc: '',
      args: [],
    );
  }
  ...
  String get your_location_cant_find_automatically_please_click_the_button_select_your_location {
    return Intl.message(
      'Your location cant find automatically please click the button & select your location',
      name: 'your_location_cant_find_automatically_please_click_the_button_select_your_location',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Cooking Instruction`
  String get cooking_instruction {
    return Intl.message(
      'Cooking Instruction',
  ...
  /// `Complete profile quickly to place order`
  String get complete_profile_quickly_to_place_order {
    return Intl.message(
      'Complete profile quickly to place order',
      name: 'complete_profile_quickly_to_place_order',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Your order will be delivered shortly, keep`
  String get your_order_will_be_delivered_shortly_keep {
    return Intl.message(
      'Your order will be delivered shortly, keep',
      name: 'your_order_will_be_delivered_shortly_keep',
      desc: '',
      args: [],
    );
  }

  /// `Complete address quickly to place order`
  String get complete_address_quickly_to_place_order {
    return Intl.message(
      'Complete address quickly to place order',
      name: 'complete_address_quickly_to_place_order',
      desc: '',
      args: [],
    );
  }
  ...
  String get add_address_at_next_step {
    return Intl.message(
      'Add Address at next step',
      name: 'add_address_at_next_step',
      desc: '',
      args: [],
    );
  }
  ...
  String get your_cart_contains_dishes_from {
    return Intl.message(
      'Your cart contains dishes from',
      name: 'your_cart_contains_dishes_from',
      desc: '',
      args: [],
    );
  }

  /// ` Do you want to discard the selection and add dishes form`
  String get do_you_want_to_discard_the_selection_and_add_dishes_form {
    return Intl.message(
      ' Do you want to discard the selection and add dishes form',
      name: 'do_you_want_to_discard_the_selection_and_add_dishes_form',
      desc: '',
      args: [],
    );
  }
  ...
  /// `View all outlet of this restaurant`
  String get view_all_outlet_of_this_restaurant {
    return Intl.message(
      'View all outlet of this restaurant',
      name: 'view_all_outlet_of_this_restaurant',
      desc: '',
      args: [],
    );
  }
  ...
  /// `HELP US FIND YOU`
  String get help_us_find_you {
    return Intl.message(
      'HELP US FIND YOU',
      name: 'help_us_find_you',
      desc: '',
      args: [],
    );
  }
  ...
  String get swipe_up_add_detailed_address_will_help_our_partner_reach_your_doorstep_easily {
    return Intl.message(
      'Swipe up! add detailed address will help our partner reach your doorstep easily',
      name: 'swipe_up_add_detailed_address_will_help_our_partner_reach_your_doorstep_easily',
      desc: '',
      args: [],
    );
  }
  ...
  /// `DIRECTIONS TO REACH`
  String get directions_to_reach {
    return Intl.message(
      'DIRECTIONS TO REACH',
      name: 'directions_to_reach',
      desc: '',
      args: [],
    );
  }
  ...
  String get ring_the_bell_on_the_red_gate {
    return Intl.message(
      'Ring the bell on the red gate',
      name: 'ring_the_bell_on_the_red_gate',
      desc: '',
      args: [],
    );
  }
  ...
  String get save_this_address_as {
    return Intl.message(
      'SAVE THIS ADDRESS AS',
      name: 'save_this_address_as',
      desc: '',
      args: [],
    );
  }
  ...
  String get search_by_restaurant {
    return Intl.message(
      'Search by restaurant',
      name: 'search_by_restaurant',
      desc: '',
      args: [],
    );
  }
  ...
  String get customize_as_per_your_taste {
    return Intl.message(
      'Customize as per your taste',
      name: 'customize_as_per_your_taste',
      desc: '',
      args: [],
    );
  }
  ...
  String get repeat_last_used_customization {
    return Intl.message(
      'Repeat Last used customization',
      name: 'repeat_last_used_customization',
      desc: '',
      args: [],
    );
  }
