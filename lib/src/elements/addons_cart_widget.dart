...
// ignore: must_be_immutable
class VariantAddonsCartSheet extends StatefulWidget {
  ...
  VariantAddonsCartSheet({Key key, this.product,this.shopDetails, this.con,this.carId, this.action}) : super(key: key);
  @override
  VariantAddonsCartSheetState createState() => VariantAddonsCartSheetState();
}

class VariantAddonsCartSheetState extends StateMVC<VariantAddonsCartSheet> {

   CartController _con;
  VariantAddonsCartSheetState() : super(CartController()) {
    _con = controller;
                                                  ...
                                                  children:[
                                                    Column(
                                                        ...
                                                        children:[
                                                          ...
                                                          Text('${S.of(context).select} 1 out of  ${variantGroupData.variant.length} options',
                          ...
                          children:[
                            ...
                            Div(
                              ...
                              if(widget.action=='edit'){
                                  ...
                                  _con.cartVariantUpdate(_con.productData,_con.keyMatcher,   _con.productData.variantGroup,
                                      _con.productData.combinationVariant, _con.productData.addonGroup, widget.carId );
                              }else {
                                if (_con.productData.variantGroup.isNotEmpty) {
                                  _con.gatewayVariant(
                                      _con.productData, widget.shopDetails,
                                      _con.keyMatcher,
