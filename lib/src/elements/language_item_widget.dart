  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () async {
        ...
        setting_repo.setting.value.mobileLanguage.value = Locale(widget.language.code, '');
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(color: Theme.of(context).focusColor.withOpacity(0.1), blurRadius: 5, offset: const Offset(0, 2)),
          ],
        ),
        child: Row(
