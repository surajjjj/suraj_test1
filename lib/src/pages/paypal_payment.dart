...
class PayPalPaymentWidget extends StatefulWidget {
  ...
  const PayPalPaymentWidget({Key key, }) : super(key: key);
  @override
  PayPalPaymentWidgetState createState() => PayPalPaymentWidgetState();
}

class PayPalPaymentWidgetState extends StateMVC<PayPalPaymentWidget> {
  PayPalController _con;

  PayPalPaymentWidgetState() : super(PayPalController()) {
    _con = controller;
