...
class RatingDriver extends StatefulWidget {
  ...
  RatingDriver({Key key, this.invoiceDetailsData}) : super(key: key);

  @override
  RatingDriverState createState() => RatingDriverState();
}

class RatingDriverState extends StateMVC<RatingDriver> {


  OrderController _con;

  RatingDriverState() : super(OrderController()) {
    _con = controller;
  }
  ...
  void initState() {
    ...
    _con.ratingDriverDate.orderId = widget.invoiceDetailsData.id;
    _con.ratingDriverDate.driver = widget.invoiceDetailsData.driverId;
    _con.ratingDriverDate.buyer = currentUser.value.id;
    _con.ratingDriverDate.rate = 4;
    super.initState();
  }
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: TextFormField(
                                        onChanged: (e){
                                          _con.ratingDriverDate.message = e;
                                        },
                                  ...
                                  Container(
                                    ...
                                    child:ElevatedButton(
                                      ...
                                      onPressed:(){
                                         _con.submitDriverRating(_con.ratingDriverDate);
                                      },
